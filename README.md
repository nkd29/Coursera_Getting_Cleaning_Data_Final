...
- 'README.md': document explaining files included in repository, and their descriptions.

- 'Codebook.md': Shows information about the variables and methods used on the feature vector.

- 'run_analysis_v4.R': Script used in the analysis and tidying of data set

- 'tidy_avg.txt': Final output table. This is the tidy table averaged across the Subject/Activity pairs.
